...
- **Scheda personaggio** completa: editing inline con salvataggio automatico, tiri salvezza, 18 abilità calcolate (competenza, **Maestria ×2**, **Factotum +½** con indicatore), combattimento, attacchi, **equipaggiamento a elenco di voci**, tratti, sezione abilità compatta con **modale dell'elenco completo** (razza / background / classe / sottoclasse / sotto-abilità selezionate / **personalizzate**), sezione incantesimi con slot (regole multiclasse + magia del patto) e modale di gestione.
